    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                foreach (Pessoa _pessoa in essasPessoas.OrderBy(n => n.Nome))
                {
                ...
                foreach (Cachorro _cachorro in essesCachorros.OrderBy(n => n.Cor))
                {
                ...
                foreach (Moto _moto in essasMotos.OrderBy(n => n.Cor))
                {
